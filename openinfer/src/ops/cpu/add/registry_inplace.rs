...
use crate::ops::registry::{InplaceKernelFn, HostInplaceKernel};
use crate::tensor::{DType, TensorValue};

use super::{
    add_inplace_bitset, add_inplace_bool, add_inplace_f16, add_inplace_f32, add_inplace_f64,
    add_inplace_i16, add_inplace_i32, add_inplace_i64, add_inplace_i8, add_inplace_u16,
    add_inplace_u32, add_inplace_u64, add_inplace_u8,
};
