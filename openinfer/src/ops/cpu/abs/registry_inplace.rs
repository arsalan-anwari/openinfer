...
pub fn lookup_kernel_cpu_abs_inplace(
    ...
    match (output_dtype, input_dtypes, attrs) {
        ...
        (DType::F16, [DType::F16], OpAttrs::None) => {
            crate::add_kernel!(InplaceUnary, "abs", F16, abs_inplace_f16)
        }
        (DType::BF16, [DType::BF16], OpAttrs::None) => {
            crate::add_kernel!(InplaceUnary, "abs", BF16, abs_inplace_bf16)
        }
        (DType::F8E5M2, [DType::F8E5M2], OpAttrs::None) => {
            crate::add_kernel!(InplaceUnary, "abs", F8E5M2, abs_inplace_f8)
        }
        (DType::I32, [DType::I32], OpAttrs::None) => {
        ...
        (DType::I1, [DType::I1], OpAttrs::None) => {
            crate::add_kernel!(InplaceUnary, "abs", I1, abs_inplace_i1)
        }
        _ => None,
    }
}
