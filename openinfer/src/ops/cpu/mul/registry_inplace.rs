...
use super::{
    mul_inplace_bitset, mul_inplace_bool, mul_inplace_f16, mul_inplace_f32, mul_inplace_f64,
    mul_inplace_i16, mul_inplace_i32, mul_inplace_i64, mul_inplace_i8, mul_inplace_u16,
    mul_inplace_u32, mul_inplace_u64, mul_inplace_u8,
};
