...
use super::{
    mul_bf16, mul_bitset, mul_bool, mul_f16, mul_f32, mul_f64, mul_f8, mul_i16, mul_i32, mul_i64,
    mul_i8, mul_u16, mul_u32, mul_u64, mul_u8, mul_i4, mul_i2, mul_i1, mul_u4, mul_u2, mul_u1,
};
...
pub fn lookup_kernel_cpu_mul(
    ...
    match (output_dtype, input_dtypes, attrs) {
        ...
        (DType::BF16, [DType::BF16, DType::BF16], &OpAttrs::None) => Some(KernelFn::Host(cpu_kernel(
            mul_bf16 as fn(&[crate::tensor::BF16], &[crate::tensor::BF16], usize) -> Result<Vec<crate::tensor::BF16>>,
        ))),
        (DType::F8E5M2, [DType::F8E5M2, DType::F8E5M2], &OpAttrs::None) => {
            Some(KernelFn::Host(cpu_kernel(
                mul_f8 as fn(&[crate::tensor::F8E5M2], &[crate::tensor::F8E5M2], usize) -> Result<Vec<crate::tensor::F8E5M2>>,
            )))
        }
