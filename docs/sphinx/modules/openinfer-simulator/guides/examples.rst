...
The `openinfer-simulator/examples` directory contains runnable programs that demonstrate
common patterns.
...
The `openinfer-oinf/examples` directory mirrors the Rust examples and shows how
