...
fn main() -> anyhow::Result<()> {
    ...
    let g = graph! {
        ...
        block entry {
            ...
            op abs(a_i4) >> abs_i4;
            op relu(a_i4, alpha=0.1, clamp_max=2.0) >> relu_i4;
            ...
            op relu(in_i8, alpha=0.1, clamp_max=2.0) >> in_i8;
            op relu(in_i16, alpha=0.1, clamp_max=2.0) >> in_i16;
            op relu(in_i32, alpha=0.1, clamp_max=2.0) >> in_i32;
            op relu(in_i64, alpha=0.1, clamp_max=2.0) >> in_i64;
            op relu(in_i4, alpha=0.1, clamp_max=2.0) >> in_i4;
