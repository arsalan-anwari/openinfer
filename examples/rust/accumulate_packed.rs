...
fn print_tensor_value(name: &str, value: TensorValue) {
    match value {
        TensorValue::I8(t) => println!("{name}: i8 {}", format_slice(&t.data)),
        TensorValue::I16(t) => println!("{name}: i16 {}", format_slice(&t.data)),
        TensorValue::I32(t) => println!("{name}: i32 {}", format_slice(&t.data)),
        TensorValue::I64(t) => println!("{name}: i64 {}", format_slice(&t.data)),
        TensorValue::U8(t) => println!("{name}: u8 {}", format_slice(&t.data)),
        TensorValue::U16(t) => println!("{name}: u16 {}", format_slice(&t.data)),
        TensorValue::U32(t) => println!("{name}: u32 {}", format_slice(&t.data)),
        TensorValue::U64(t) => println!("{name}: u64 {}", format_slice(&t.data)),
        other => println!("{name}: dtype={:?}", other.dtype()),
    }
}
